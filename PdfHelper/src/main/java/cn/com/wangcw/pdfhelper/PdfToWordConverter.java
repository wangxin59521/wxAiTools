...
/**
 * PDF转Word工具类
 * 该工具类可以将扫描版PDF文件通过OCR技术转换为Word格式文档
 */
public class PdfToWordConverter {
     ...
     */
    public void convertPdfToWord(String pdfPath, String wordPath) throws IOException, TesseractException {
        ...
        try {
            for (int page = 0; page < document.getNumberOfPages(); page++) {
                ...
                // 分析文本结构并添加到Word文档
                analyzeAndAddToWord(wordDocument, text);
     ...
     */
    private void analyzeAndAddToWord(XWPFDocument wordDocument, String text) {
        ...
        for (String line : lines) {
            ...
            if (line.isEmpty()) {
                wordDocument.createParagraph(); // 空行
                if (inList) {
                    inList = false;
                }
                continue;
            ...
            if (listMatcher.matches()) {
                ...
                run.setText(listMatcher.group(2).trim());
                continue;
            }
